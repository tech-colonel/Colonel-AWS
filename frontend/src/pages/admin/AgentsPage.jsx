...
const sectionOf = (agent) => {
  ...
  if (/amazon|flipkart|meesho|myntra|nykaa|ajio|jiomart|firstcry|shopify|blinkit|zepto|tatacliq|pepperfry|seller|marketplace|mtr/.test(n)) return 'marketplace';
  return 'other';
};
